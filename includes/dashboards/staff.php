...
<div class="alert alert-error">
    Your staff profile is not linked to a faculty record. Contact the administration office to enable teaching access, payslips, and student lists.
</div>
<?php else: ?>
...
<div class="card" style="margin-bottom:24px;">
    ...
    <div class="card-body">
        <div class="detail-grid">
            ...
            <div class="detail-item"><label>Role</label><span><?= getRoleLabel($_SESSION['user_role'] ?? 'staff') ?></span></div>
        </div>
    </div>
</div>
